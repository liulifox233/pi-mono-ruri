...
Prompt content.`,
		...
		it("should prefer project resources over user on name collisions", async () => {
			...
			const projectPromptsDir = join(cwd, ".config", "rpi", "prompts");
			...
			const projectSkillDir = join(cwd, ".config", "rpi", "skills", "collision-skill");
...
Project skill`,
			...
			const projectThemePath = join(cwd, ".config", "rpi", "themes", "collision.json");
			mkdirSync(join(agentDir, "themes"), { recursive: true });
			mkdirSync(join(cwd, ".config", "rpi", "themes"), { recursive: true });
		...
		it("should keep both extensions loaded when command names collide", async () => {
			...
			const projectExtDir = join(cwd, ".config", "rpi", "extensions");
...
Content`,
		...
		it("should discover SYSTEM.md from cwd/.config/rpi", async () => {
			const piDir = join(cwd, ".config", "rpi");
