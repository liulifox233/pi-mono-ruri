 ...
 * Encodes cwd into a safe directory name under ~/.config/rpi/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.config/rpi/agent/sessions/<encoded-cwd>/).
	 */
