...
// ============================================================================
// OAuth API key resolution from ~/.config/rpi/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".config", "rpi", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.config/rpi/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.config/rpi/agent/auth.json
 */
...
export const PI_AGENT_DIR = join(homedir(), ".config", "rpi", "agent");

/**
 * Get an AuthStorage instance backed by ~/.config/rpi/agent/auth.json
