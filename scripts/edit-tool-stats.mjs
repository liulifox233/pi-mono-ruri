...
const DEFAULT_SESSIONS_DIR = path.join(homedir(), ".config/rpi/agent/sessions");
const DEFAULT_ACTIVE_EDIT_EXTENSION_PATH = path.join(homedir(), ".config/rpi/agent/extensions/edit.ts");
...
Options:
  --sessions-dir <path>  Sessions directory (default: ~/.config/rpi/agent/sessions)
