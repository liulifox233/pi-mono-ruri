...
/**
 * Migrate sessions from ~/.config/rpi/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.config/rpi/agent/ instead of
 * ~/.config/rpi/agent/sessions/<encoded-cwd>/. This migration moves them
